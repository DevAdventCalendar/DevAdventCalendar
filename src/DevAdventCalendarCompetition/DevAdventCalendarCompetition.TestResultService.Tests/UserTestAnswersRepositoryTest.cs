...
namespace DevAdventCalendarCompetition.TestResultService.Tests
{
    ...
    {
        private readonly UserTestAnswersRepository userTestAnswersRepository;
        ...
        {
            //Act
            var results = userTestAnswersRepository.GetCorrectAnswersPerUserForDateRange(
        ...
        {
            //Act
            var results = userTestAnswersRepository.GetAnsweringTimeSumPerUserForDateRange(
                new DateTime(2019, 12, 1, 20, 0, 0),
                new DateTime(2019, 12, 24, 23, 59, 0)
            );
